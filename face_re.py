...
out = cv2.VideoWriter('/home/aioz-nam/Code/HC/data/test2out.mp4', cv2.VideoWriter_fourcc(*'DIVX'), 25, (1280, 720))
face_module = face_re()
...
while(True):
    ...
    begin = time.time()
    success, boxes, predictions, face_status, yaw, emotion_text = face_module.re_face(frame)
    if(success):
        print("FPS: ", 1/(time.time() - begin), face_status, yaw, emotion_text)
