...
class face_re():
    def __init__(self):
        ...
        model_path = "/home/aioz-nam/Code/HC/face_recognition/models/facial_landmarks/shape_predictor_68_face_landmarks.dat"
        shape_predictor_68 = dlib.shape_predictor(model_path)
        self.fa = face_utils.facealigner.FaceAligner(shape_predictor, shape_predictor_68, desiredFaceWidth=112, desiredLeftEye=(0.3, 0.3))
